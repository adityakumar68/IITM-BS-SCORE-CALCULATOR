...
const TabComponent = () => {
  ...
  const handleSubmit = () => {
    ...
    const formulas = {
      ...
      'SC': scores =>  Math.max(0.3*scores['endterm']+ 0.2*Math.max(scores['quiz1'], scores['quiz2']) , 0.3*scores['endterm']+0.15*scores['quiz1']+0.15*scores['quiz2'])+0.06*scores['ga']+1*scores['bonus']+0.15*scores['oppe1']+0.2*scores['oppe2']+1*scores['nppe1+2 sc'],
